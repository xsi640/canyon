...
object BitConverter {
    ...
    fun getBytes(cArray: CharArray): ByteArray {
        return BitConverter.getBytes(String(cArray), BitConverter.DEFAULT_CHARSET)
    }
    ...
    fun getBytes(cArray: CharArray, charset: Charset): ByteArray {
        return BitConverter.getBytes(String(cArray), charset)
    }
    ...
    fun toCharArray(bytes: ByteArray): CharArray {
        return BitConverter.toString(bytes, BitConverter.DEFAULT_CHARSET).toCharArray()
    }
    ...
    fun toCharArray(bytes: ByteArray, charset: Charset): CharArray {
        return BitConverter.toString(bytes, charset).toCharArray()
    }
     ...
     */
    @JvmOverloads
    fun getBytes(s: String, charset: Charset = BitConverter.DEFAULT_CHARSET): ByteArray {
     ...
     */
    @JvmOverloads
    fun toString(bytes: ByteArray, charset: Charset = BitConverter.DEFAULT_CHARSET): String {
